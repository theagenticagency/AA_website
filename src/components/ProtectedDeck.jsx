...
const SESSION_KEY = 'deck_auth';

export default function ProtectedDeck() {
  ...
  return (
    <>
      <Helmet>
        <meta name="robots" content="noindex, nofollow" />
        <meta name="googlebot" content="noindex, nofollow" />
        <title>Agentic Agency Pitch</title>
      </Helmet>
      <div className="min-h-screen bg-black flex items-center justify-center font-['Space_Grotesk'] p-4">
        <div className="w-full max-w-sm text-center">
          <h1 className="text-[#E6E6E1] text-2xl font-bold uppercase tracking-widest mb-12">
            Agentic Agency Pitch
          </h1>
